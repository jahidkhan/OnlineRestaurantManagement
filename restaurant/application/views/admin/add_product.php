...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h2><i class="icon-edit"></i> Add Menu</h2>
        ...
        <div class="box-content">
            <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>super_admin/save_product" method="post">
                <fieldset>
                    <legend></legend>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Menu Category  </label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Menu Price  </label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span6 typeahead" id="typeahead"  name="old_price">

                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Menu Quantity  </label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Featured Menu  </label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Menu  Image </label>
                        <div class="controls">
