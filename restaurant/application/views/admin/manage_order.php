        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="center">
                    ...
                    <a class="btn btn-info" href="<?php echo base_url();?>super_admin/view_invoice/<?php echo $v_order->order_id?>" title="view">
                        ...
                        <a class="btn btn-success" href="<?php echo base_url();?>super_admin/download/<?php echo $v_order->order_id?>" title="download">
