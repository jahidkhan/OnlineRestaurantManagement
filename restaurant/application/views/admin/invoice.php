...
<form method="post" action="#"><select name="gateway" size="1" onChange="submit()"><option value="tco" selected>1. Cash On Delivery</option><option value="paypal">2. PayPal</option><option value="moneybookers">3. Moneybookers</option></select></form>
...
<?php echo $shipping_info->company_name;?><br>
<?php echo $billing_info->first_name.' '.$billing_info->last_name;?><br>
<?php echo $billing_info->email_address;?> <br>
<?php echo $billing_info->address;?> <br>
<?php echo $billing_info->mobile;?> <br>


<script type="text/javascript">
    
    var key='<?php echo $billing_info->city;?>';
   // alert(key);
...
<?php echo $billing_info->email_address;?> <br>
<?php echo $billing_info->mobile;?> <br>
<?php echo $shipping_info->city;?><br>
<script type="text/javascript">
    
    var key='<?php echo $shipping_info->city;?>';
   // alert(key);
   country= getCountryFullName(key);
    document.write(country);
</script>
